...
void x18_hash(const char* input, char* output, uint32_t len)
{
    ...
    sph_sha512_context      ctx_sha5121;
    sph_haval256_5_context    ctx_haval1;
    sph_tiger_context       ctx_tiger1;
    ...
    sph_sha512_init(&ctx_sha5121);
    sph_sha512(&ctx_sha5121,(const void*) hashA, 64);
    sph_sha512_close(&ctx_sha5121,(void*) hashB);

    sph_haval256_5_init(&ctx_haval1);
    sph_haval256_5 (&ctx_haval1, hashB, 64);
    sph_haval256_5_close(&ctx_haval1, hashA);

    sph_tiger_init (&ctx_tiger1);
    sph_tiger (&ctx_tiger1, hashA, 64);
    sph_tiger_close(&ctx_tiger1, hashB);
